...
const GalerySettings = () => {
  ...
  const handleSave = async () => {
    ...
    formData.append("resim", resimPath);

    const response = await fetch(
      "http://localhost/Projeler/PixelEvren/PixelEvren_BackEnd/Api/galery.php",
      {
        method: "POST",
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        // Beklenen: doğrudan array veya { images: [...] }
  ...
  const handleDelete = async (id) => {
    ...
    const res = await fetch(
      "http://localhost/Projeler/PixelEvren/PixelEvren_BackEnd/Api/delete-galery.php",
      {
        method: "POST",
        body: formData,
      },
        ...
        <main className="flex-1 p-6 md:p-10 bg-gray-100 overflow-x-hidden">
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            ...
            <p className="text-gray-600">
              Burada galery ayarlarını düzenleyebilirsiniz.
            </p>
          </div>
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <div className="relative h-28 w-full rounded-lg border border-gray-300 bg-gray-50 flex justify-center items-center shadow-sm hover:shadow-md transition">
                  ...
                  <input
                    type="file"
                    onChange={(e) => setResimPath(e.target.files[0])}
