...
const ForumCategories = () => {
  ...
  const handleSave = async () => {
    ...
    const response = await fetch(
      "http://localhost/Projeler/PixelEvren/PixelEvren_BackEnd/Api/forum-categories.php",
      {
        method: "POST",
  ...
  const handleDelete = async (id) => {
    ...
    const res = await fetch(
      "http://localhost/Projeler/PixelEvren/PixelEvren_BackEnd/Api/delete-forum-categories.php",
      {
        method: "POST",
        body: formData,
      },
        ...
        <main className="flex-1 p-6 md:p-10 bg-gray-100 overflow-x-hidden">
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            ...
            <p className="text-gray-600">
              Burada forum kategorilerini düzenleyebilirsiniz.
            </p>
          </div>
