...
const Members = () => {
    ...
    const load = async () => {
      try {
        const res = await fetch(
          "http://localhost/Projeler/PixelEvren/PixelEvren_BackEnd/Api/get-members.php",
        );
  ...
  const handleDelete = async (id) => {
    ...
    const res = await fetch(
      "http://localhost/Projeler/PixelEvren/PixelEvren_BackEnd/Api/delete-members.php",
      {
        method: "POST",
        body: formData,
      },
      ...
      <div className="flex flex-1 relative">
        ...
        <main className="flex-1 p-6 md:p-10 bg-gray-100 overflow-x-hidden">
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            <h3 className="text-2xl font-bold mb-2 text-gray-800">Üyeler</h3>
            <p className="text-gray-600">
              Burada gelen üyeleri düzenleyebilirsiniz.
            </p>
          </div>
              ...
              <table className="min-w-full border border-gray-300 bg-white rounded-lg shadow">
                <thead className="bg-gray-200">
                  <tr>
                    ...
                    <th className="px-4 py-2 text-center">Sifre</th>
                    <th>Rol</th>
                    <th>Tarih</th>
                    <th>Sil</th>
                  </tr>
                ...
                <tbody>
                  {user.map((item) => (
                    ...
                    >
                      <td className="px-4 py-2">{item.kullanici_adi}</td>
